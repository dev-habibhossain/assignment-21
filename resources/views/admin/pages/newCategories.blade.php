        ...
        <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="categoryName" name="name" type="text" value="{{ old('name') }}" placeholder="e.g., Technology" class="mt-1 block w-full rounded-md border-gray-200 shadow-sm px-4 py-3 focus:border-gray-800 focus:ring-2 focus:ring-gray-200" required>
                </div>
                ...
                <div>
                    ...
                    <input id="categoryImage" name="image_url" type="url" value="{{ old('image_url') }}" placeholder="https://..." class="mt-1 block w-full rounded-md border-gray-200 px-4 py-3 focus:border-gray-800 focus:ring-2 focus:ring-gray-200">
