	...
	<div class="bg-white p-6 rounded shadow border border-gray-200">
		...
		<form action="/admin/posts" method="POST" enctype="multipart/form-data" class="space-y-6">
			...
			<div>
				...
				<textarea name="content" rows="10" class="mt-1 block w-full rounded border-gray-300 focus:border-gray-800 focus:ring-1 focus:ring-gray-800">Write full article content here...</textarea>
			</div>
			...
			<div class="flex items-center gap-3">
				<button type="submit" class="px-4 py-2 bg-gray-800 text-white rounded font-semibold">Create Post</button>
